...
namespace ConsoleAppWebService.ShowFileRef {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="ShowFileRef.WebServiceERP12Soap")]
    public interface WebServiceERP12Soap {
        ...
        ConsoleAppWebService.ShowFileRef.Employee CreateEmployee(string no, string FirstName, string lastName, string jobTitle, string address, string phoneNumber, string email, string ssn);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/CreateEmployee", ReplyAction="*")]
        System.Threading.Tasks.Task<ConsoleAppWebService.ShowFileRef.Employee> CreateEmployeeAsync(string no, string FirstName, string lastName, string jobTitle, string address, string phoneNumber, string email, string ssn);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/FindEmployee", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        ConsoleAppWebService.ShowFileRef.Employee FindEmployee(string no);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/FindEmployee", ReplyAction="*")]
        System.Threading.Tasks.Task<ConsoleAppWebService.ShowFileRef.Employee> FindEmployeeAsync(string no);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/UpdateEmployee", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        ConsoleAppWebService.ShowFileRef.Employee UpdateEmployee(string no, string firstName, string lastName, string jobTitle, string address, string phoneNumber, string email);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/UpdateEmployee", ReplyAction="*")]
        System.Threading.Tasks.Task<ConsoleAppWebService.ShowFileRef.Employee> UpdateEmployeeAsync(string no, string firstName, string lastName, string jobTitle, string address, string phoneNumber, string email);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface WebServiceERP12SoapChannel : ConsoleAppWebService.ShowFileRef.WebServiceERP12Soap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class WebServiceERP12SoapClient : System.ServiceModel.ClientBase<ConsoleAppWebService.ShowFileRef.WebServiceERP12Soap>, ConsoleAppWebService.ShowFileRef.WebServiceERP12Soap {
        ...
        public ConsoleAppWebService.ShowFileRef.Employee CreateEmployee(string no, string FirstName, string lastName, string jobTitle, string address, string phoneNumber, string email, string ssn) {
            return base.Channel.CreateEmployee(no, FirstName, lastName, jobTitle, address, phoneNumber, email, ssn);
        }
        
        public System.Threading.Tasks.Task<ConsoleAppWebService.ShowFileRef.Employee> CreateEmployeeAsync(string no, string FirstName, string lastName, string jobTitle, string address, string phoneNumber, string email, string ssn) {
            return base.Channel.CreateEmployeeAsync(no, FirstName, lastName, jobTitle, address, phoneNumber, email, ssn);
        }
        
        public ConsoleAppWebService.ShowFileRef.Employee FindEmployee(string no) {
            return base.Channel.FindEmployee(no);
        }
        
        public System.Threading.Tasks.Task<ConsoleAppWebService.ShowFileRef.Employee> FindEmployeeAsync(string no) {
            return base.Channel.FindEmployeeAsync(no);
        }
        
        public ConsoleAppWebService.ShowFileRef.Employee UpdateEmployee(string no, string firstName, string lastName, string jobTitle, string address, string phoneNumber, string email) {
            return base.Channel.UpdateEmployee(no, firstName, lastName, jobTitle, address, phoneNumber, email);
        }
        
        public System.Threading.Tasks.Task<ConsoleAppWebService.ShowFileRef.Employee> UpdateEmployeeAsync(string no, string firstName, string lastName, string jobTitle, string address, string phoneNumber, string email) {
