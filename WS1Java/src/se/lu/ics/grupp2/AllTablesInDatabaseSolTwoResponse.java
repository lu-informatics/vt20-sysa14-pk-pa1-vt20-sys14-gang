...
public class AllTablesInDatabaseSolTwoResponse  implements java.io.Serializable {
    private java.lang.String[] allTablesInDatabaseSolTwoResult;

    public AllTablesInDatabaseSolTwoResponse() {
    }

    public AllTablesInDatabaseSolTwoResponse(
           java.lang.String[] allTablesInDatabaseSolTwoResult) {
     ...
     */
    public java.lang.String[] getAllTablesInDatabaseSolTwoResult() {
        return allTablesInDatabaseSolTwoResult;
    }
     ...
     */
    public void setAllTablesInDatabaseSolTwoResult(java.lang.String[] allTablesInDatabaseSolTwoResult) {
        this.allTablesInDatabaseSolTwoResult = allTablesInDatabaseSolTwoResult;
    }
        ...
        _equals = true && 
            ((this.allTablesInDatabaseSolTwoResult==null && other.getAllTablesInDatabaseSolTwoResult()==null) || 
             (this.allTablesInDatabaseSolTwoResult!=null &&
              java.util.Arrays.equals(this.allTablesInDatabaseSolTwoResult, other.getAllTablesInDatabaseSolTwoResult())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getAllTablesInDatabaseSolTwoResult() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getAllTablesInDatabaseSolTwoResult());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getAllTablesInDatabaseSolTwoResult(), i);
                if (obj != null &&
