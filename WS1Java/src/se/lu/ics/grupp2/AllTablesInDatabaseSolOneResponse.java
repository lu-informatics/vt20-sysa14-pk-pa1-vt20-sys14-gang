...
public class AllTablesInDatabaseSolOneResponse  implements java.io.Serializable {
    private java.lang.String[] allTablesInDatabaseSolOneResult;

    public AllTablesInDatabaseSolOneResponse() {
    }

    public AllTablesInDatabaseSolOneResponse(
           java.lang.String[] allTablesInDatabaseSolOneResult) {
     ...
     */
    public java.lang.String[] getAllTablesInDatabaseSolOneResult() {
        return allTablesInDatabaseSolOneResult;
    }
     ...
     */
    public void setAllTablesInDatabaseSolOneResult(java.lang.String[] allTablesInDatabaseSolOneResult) {
        this.allTablesInDatabaseSolOneResult = allTablesInDatabaseSolOneResult;
    }
        ...
        _equals = true && 
            ((this.allTablesInDatabaseSolOneResult==null && other.getAllTablesInDatabaseSolOneResult()==null) || 
             (this.allTablesInDatabaseSolOneResult!=null &&
              java.util.Arrays.equals(this.allTablesInDatabaseSolOneResult, other.getAllTablesInDatabaseSolOneResult())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getAllTablesInDatabaseSolOneResult() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getAllTablesInDatabaseSolOneResult());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getAllTablesInDatabaseSolOneResult(), i);
                if (obj != null &&
