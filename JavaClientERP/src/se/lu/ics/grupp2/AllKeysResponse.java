...
public class AllKeysResponse  implements java.io.Serializable {
    private java.lang.String[] allKeysResult;

    public AllKeysResponse() {
    }

    public AllKeysResponse(
           java.lang.String[] allKeysResult) {
     ...
     */
    public java.lang.String[] getAllKeysResult() {
        return allKeysResult;
    }
     ...
     * @param allKeysResult
     */
    public void setAllKeysResult(java.lang.String[] allKeysResult) {
        this.allKeysResult = allKeysResult;
    }
        ...
        _equals = true && 
            ((this.allKeysResult==null && other.getAllKeysResult()==null) || 
             (this.allKeysResult!=null &&
              java.util.Arrays.equals(this.allKeysResult, other.getAllKeysResult())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getAllKeysResult() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getAllKeysResult());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getAllKeysResult(), i);
                if (obj != null &&
