...
namespace ProgramKonstruktion.NewWebRef {
    using System.Data;
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://grupp2.ics.lu.se/", ConfigurationName="NewWebRef.WebServiceERP12Soap")]
    public interface WebServiceERP12Soap {
        ...
        ProgramKonstruktion.NewWebRef.Employee CreateEmployee(string no, string FirstName, string lastName, string jobTitle, string address, string phoneNumber, string email, string ssn);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://grupp2.ics.lu.se/CreateEmployee", ReplyAction="*")]
        System.Threading.Tasks.Task<ProgramKonstruktion.NewWebRef.Employee> CreateEmployeeAsync(string no, string FirstName, string lastName, string jobTitle, string address, string phoneNumber, string email, string ssn);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://grupp2.ics.lu.se/FindEmployee", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        ProgramKonstruktion.NewWebRef.Employee FindEmployee(string no);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://grupp2.ics.lu.se/FindEmployee", ReplyAction="*")]
        System.Threading.Tasks.Task<ProgramKonstruktion.NewWebRef.Employee> FindEmployeeAsync(string no);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://grupp2.ics.lu.se/UpdateEmployee", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        ProgramKonstruktion.NewWebRef.Employee UpdateEmployee(string no, string firstName, string lastName, string jobTitle, string address, string phoneNumber, string email);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://grupp2.ics.lu.se/UpdateEmployee", ReplyAction="*")]
        System.Threading.Tasks.Task<ProgramKonstruktion.NewWebRef.Employee> UpdateEmployeeAsync(string no, string firstName, string lastName, string jobTitle, string address, string phoneNumber, string email);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface WebServiceERP12SoapChannel : ProgramKonstruktion.NewWebRef.WebServiceERP12Soap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class WebServiceERP12SoapClient : System.ServiceModel.ClientBase<ProgramKonstruktion.NewWebRef.WebServiceERP12Soap>, ProgramKonstruktion.NewWebRef.WebServiceERP12Soap {
        ...
        public ProgramKonstruktion.NewWebRef.Employee CreateEmployee(string no, string FirstName, string lastName, string jobTitle, string address, string phoneNumber, string email, string ssn) {
            return base.Channel.CreateEmployee(no, FirstName, lastName, jobTitle, address, phoneNumber, email, ssn);
        }
        
        public System.Threading.Tasks.Task<ProgramKonstruktion.NewWebRef.Employee> CreateEmployeeAsync(string no, string FirstName, string lastName, string jobTitle, string address, string phoneNumber, string email, string ssn) {
            return base.Channel.CreateEmployeeAsync(no, FirstName, lastName, jobTitle, address, phoneNumber, email, ssn);
        }
        
        public ProgramKonstruktion.NewWebRef.Employee FindEmployee(string no) {
            return base.Channel.FindEmployee(no);
        }
        
        public System.Threading.Tasks.Task<ProgramKonstruktion.NewWebRef.Employee> FindEmployeeAsync(string no) {
            return base.Channel.FindEmployeeAsync(no);
        }
        
        public ProgramKonstruktion.NewWebRef.Employee UpdateEmployee(string no, string firstName, string lastName, string jobTitle, string address, string phoneNumber, string email) {
            return base.Channel.UpdateEmployee(no, firstName, lastName, jobTitle, address, phoneNumber, email);
        }
        
        public System.Threading.Tasks.Task<ProgramKonstruktion.NewWebRef.Employee> UpdateEmployeeAsync(string no, string firstName, string lastName, string jobTitle, string address, string phoneNumber, string email) {
