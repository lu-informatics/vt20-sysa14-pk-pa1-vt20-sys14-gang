...
public class AllIndexesResponse  implements java.io.Serializable {
    private se.lu.ics.grupp2.AllIndexesResponseAllIndexesResult allIndexesResult;

    public AllIndexesResponse() {
    }

    public AllIndexesResponse(
           se.lu.ics.grupp2.AllIndexesResponseAllIndexesResult allIndexesResult) {
     ...
     */
    public se.lu.ics.grupp2.AllIndexesResponseAllIndexesResult getAllIndexesResult() {
        return allIndexesResult;
    }
     ...
     */
    public void setAllIndexesResult(se.lu.ics.grupp2.AllIndexesResponseAllIndexesResult allIndexesResult) {
        this.allIndexesResult = allIndexesResult;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://grupp2.ics.lu.se/", ">AllIndexesResponse"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("allIndexesResult");
        elemField.setXmlName(new javax.xml.namespace.QName("http://grupp2.ics.lu.se/", "AllIndexesResult"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://grupp2.ics.lu.se/", ">>AllIndexesResponse>AllIndexesResult"));
